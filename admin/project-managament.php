...
$sql = "SELECT id, name, summary, created_at, image_path1 FROM projects ORDER BY created_at LIMIT $itemsPerPage OFFSET $offset";
                            ...
                            <div class="medya-card" onclick="toggleCheckbox(this)">
                                ...
                                <div class="medya-details">
                                    ...
                                    <div class="button-container">
                                        <a href="proje_duzenle.php?id=<?php echo $row['id']; ?>" class="edit-button">Düzenle</a>
