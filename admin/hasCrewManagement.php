...
<head>
    ...
    <link rel="stylesheet" href="admincss/newsManagement.css"> <!-- Mevcut CSS dosyasını kullanabilirsiniz -->
                                ...
                                <div class="medya-details">
                                    ...
                                    <p class="social-links">
                                        ...
                                        <?php if (!empty($row['twitter'])): ?>
                                            | <a href="<?php echo htmlspecialchars($row['twitter']); ?>" target="_blank">Twitter</a>
                                        <?php endif; ?>
                                        <?php if (!empty($row['youtube'])): ?>
                                            | <a href="<?php echo htmlspecialchars($row['youtube']); ?>" target="_blank">YouTube</a>
                                        <?php endif; ?>
                                    </p>
